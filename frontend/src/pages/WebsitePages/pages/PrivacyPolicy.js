...
function PrivacyPolicy() {
  return (
    <>
      ...
      <MKBox sx={{ marginLeft: 10, marginRight: 10, fontSize: 14 }}>
        <h2>Privacy Policy for Marketi</h2>

        <p>
          At Marketi, accessible from https:www.marketi.com, one of our main priorities is the
          privacy of our visitors. This Privacy Policy document contains types of information that
          is collected and recorded by Marketi and how we use it.
        </p>
        ...
        <p>
          ...
          website with regards to the information that they shared and/or collect in Marketi. This
        ...
        <p>
          Marketi follows a standard procedure of using log files. These files log visitors when
        ...
        <p>
          ...
          Beacons that are used in their respective advertisements and links that appear on Marketi,
        ...
        <p>
          Note that Marketi has no access to or control over these cookies that are used by
        ...
        <p>
          Marketi Privacy Policy does not apply to other advertisers or websites. Thus, we are
        ...
        <p>
          Request that a business that collects a consumer personal data disclose the categories and
        ...
        <p>
          Request that a business that sells a consumer[] personal data, not sell the consumer
          personal data.
        </p>
        <p>
        ...
        <p>
          Marketi does not knowingly collect any Personal Identifiable Information from children
