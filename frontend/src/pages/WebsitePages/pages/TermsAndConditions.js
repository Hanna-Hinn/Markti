    ...
    <>
      ...
      <MKBox sx={{ marginLeft: 10, marginRight: 10, FontSize: 14 }}>
        ...
        <ul>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Marketi, accessible from{" "}
              <a
                href="http://www.marketi.com"
                rel="external nofollow noopener noreferrer"
                target="_blank"
              >
                http://www.marketi.com
              </a>
            </p>
          </li>
          <li>
        ...
        <p>
          ...
          may not apply. In these states, each party is liability will be limited to the greatest
        ...
        <p>
          Without limiting the foregoing, neither the Company nor any of the company provider makes
