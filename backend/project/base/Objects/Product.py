class Product:
    ...
    def __init__(self, description=None,product_id=None, product_title=None, product_category=None, product_image=None, product_url=None, product_price=None, product_rating=None, product_store=None, product_storeImage=None):
